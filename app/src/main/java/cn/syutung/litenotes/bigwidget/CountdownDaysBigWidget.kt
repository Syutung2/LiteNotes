 ...
 * App Widget Configuration implemented in [CountdownDaysBigWidgetConfigureActivity]
 */
class CountdownDaysBigWidget : AppWidgetProvider() {
...
{
    var m = abs((endDate.timeInMillis - nowDate.timeInMillis) / (1000 * 3600 * 24) ).toInt()
    return m
...
internal fun updateAppWidget(
    ...
    thread {
        ...
        val views = RemoteViews(context.packageName, R.layout.countdown_days_big_widget)
        if (p != null) {
