package cn.syutung.litenotes.bigwidget
...
import cn.syutung.litenotes.databinding.CountdownDaysBigWidgetConfigureBinding
...
/**
 * The configuration screen for the [CountdownDaysBigWidget] AppWidget.
 */
class CountdownDaysBigWidgetConfigureActivity : Activity() {
    private var appWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID
    private lateinit var appWidgetText: EditText

    private lateinit var binding: CountdownDaysBigWidgetConfigureBinding
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        binding = CountdownDaysBigWidgetConfigureBinding.inflate(layoutInflater)
...
private const val PREFS_NAME = "cn.syutung.litenotes.bigwidget.CountdownDaysBigWidget"
